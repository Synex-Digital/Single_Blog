                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="{{ route('category.store') }}" method="POST"  enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control @error('category_name') is-invalid @enderror" id="val-username" name="category_name" placeholder="Category name">
                                    @error('category_name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" id="val-username" name="seo_title" placeholder="Seo title">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" id="val-username" name="seo_tags" placeholder="Entire tags here">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                   <textarea class="form-control" name="seo_description" id="" cols="30" rows="10" placeholder="Description"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
