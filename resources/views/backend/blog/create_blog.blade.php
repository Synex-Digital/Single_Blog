                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="{{ route('blog.store') }}" method="POST"  enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control @error('blog_title') is-invalid @enderror" id="val-username" name="blog_title" placeholder="Blog Title">
                                    @error('blog_title')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control @error('seo_title') is-invalid @enderror" id="val-username" name="seo_title" placeholder="SEO Title">
                                    @error('seo_title')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control @error('seo_tags') is-invalid @enderror" id="val-username" name="seo_tags" placeholder="SEO Tags">
                                    @error('seo_tags')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                   <textarea style="height: 130px;" class="form-control" name="seo_description" id="" cols="30" rows="10" placeholder="Description"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                   <textarea class="summernote" name="blog_description" id="" cols="30" rows="10" placeholder="Description"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
